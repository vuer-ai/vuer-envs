...
from ACT import ACTION_DIM, LATENT_DIM, QPOS_DIM, ROBOT_STATE_DIM
...
class CNNMLP(nn.Module):
    def __init__(self, backbones, state_dim, camera_names):
        ...
        if backbones is not None:
            ...
            mlp_in_dim = 768 * len(backbones) + 12
    ...
    def forward(self, qpos, image, env_state, actions=None):
        ...
        features = torch.cat([flattened_features, qpos], axis=1)  # qpos: 12
