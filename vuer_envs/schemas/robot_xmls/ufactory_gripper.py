...
class UfactoryGripper(Body):
    ...
    <contact>
      ...
      <exclude body1="left_inner_knuckle" body2="{name}"/>
      <exclude body1="right_inner_knuckle" body2="{name}"/>
      <exclude body1="left_outer_knuckle" body2="{name}"/>
      <exclude body1="right_outer_knuckle" body2="{name}"/>
    </contact>
