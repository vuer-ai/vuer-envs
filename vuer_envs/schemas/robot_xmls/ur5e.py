...
class UR5e(Body):
    ...
    <body name="{name}-shoulder_link" pos="0 0 0.163">
      ...
      <joint name="{name}-shoulder_pan_joint" class="size3" axis="0 0 1"/>
      ...
      <body name="{name}-upper_arm_link" pos="0 0.138 0" quat="1 0 1 0">
        ...
        <joint name="{name}-shoulder_lift_joint" class="size3"/>
        ...
        <body name="{name}-forearm_link" pos="0 -0.131 0.425">
          ...
          <joint name="{name}-elbow_joint" class="size3_limited"/>
          ...
          <body name="{name}-wrist_1_link" pos="0 0 0.392" quat="1 0 1 0">
            ...
            <joint name="{name}-wrist_1_joint" class="size1"/>
            ...
            <body name="{name}-wrist_2_link" pos="0 0.127 0">
              ...
              <joint name="{name}-wrist_2_joint" axis="0 0 1" class="size1"/>
              ...
              <body name="{name}-wrist_3_link" pos="0 0 0.1">
                ...
                <joint name="{name}-wrist_3_joint" class="size1"/>
    ...
    _postamble = """
    <actuator>
      <general class="size3" name="{name}-shoulder_pan" joint="{name}-shoulder_pan_joint"/>
      <general class="size3" name="{name}-shoulder_lift" joint="{name}-shoulder_lift_joint"/>
      <general class="size3_limited" name="{name}-elbow" joint="{name}-elbow_joint"/>
      <general class="size1" name="{name}-wrist_1" joint="{name}-wrist_1_joint"/>
      <general class="size1" name="{name}-wrist_2" joint="{name}-wrist_2_joint"/>
      <general class="size1" name="{name}-wrist_3" joint="{name}-wrist_3_joint"/>
    </actuator>
    """
