...
from lucid_splatting.dn_model import Model
from lucidxr_base.utils.tf_utils import get_camera_extrinsic_matrix
from lucidxr_base.wrappers.movable_camera_wrapper import MovableCameraWrapper

DATASET_ROOT = os.environ.get("LUCIDSIM_EVAL_DATASETS")
...
class SplatWrapper(MovableCameraWrapper):
    """
