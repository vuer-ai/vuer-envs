...
from lucidxr_base.utils.depth_util import invisibility
from lucidxr_base.utils.tf_utils import get_camera_extrinsic_matrix, get_camera_intrinsic_matrix
from optical_flow import warp_forward

from lucidxr_base.wrappers.movable_camera_wrapper import MovableCameraWrapper


class OpticalFlowWrapper(MovableCameraWrapper):
    def w__init__(
        self,
        env,
        *,
