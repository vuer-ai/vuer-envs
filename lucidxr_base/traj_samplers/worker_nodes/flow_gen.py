...
import lucidxr_base
from lucidxr_base.utils.utils import pick, warp_forward
from lucidxr_base.wrappers.optical_flow_wrapper import OpticalFlowWrapper
...
def main(poses, source_images: List[TensorType], **deps):
    ...
    env = lucidxr_base.make(FlowGen.env_name, device=FlowGen.device, random=FlowGen.seed, optical_flow_camera=FlowGen.camera_name)
    # add setting camera position
